...
int main( )
   ...
   StringView numbers( "\x02\x81\x01\xFF\x00\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFC\x14\x7A\x6E\x87\x46\x11", 20 );
   ...
   StringView numbers2( "\x82\x01\x02\xFF\x80\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\x00\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF", 23 );

   // Backward string with Utf8Uints of value:
   // 2, 257, 18.446.744.073.709.551.615, and 22.516.072.924.689
   StringView numbers3( "\x11\x46\x87\x6E\x7A\x14\xFC\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\x00\xFF\x01\x81\x02", 20 );

   // Backward string with PairUtf8Uints of value:
   // (2, 1) [Formatted incorrectly], (2, 1), and (18,446,744,073,709,551,615, 18,446,744,073,709,551,615)
   StringView numbers4( "\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\x00\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\x80\xFF\x02\x01\x82", 23 );
